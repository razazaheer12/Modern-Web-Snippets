...
Fully Responsive: Adapts seamlessly to all screen sizes using CSS Media Queries.

Clean Typography: Uses the 'Poppins' font for a professional look.
...
Bash
git clone https://github.com/razazaheer12/your-repo-name.git
Open the file:
